...
Репозиторий это хранилище всех файлов, включая и созданные папки игнорирования. Для создания репозитория используется команда *git init*. Чтобы созадать репозиторий напишите в терминале с открытой папкой для репозитория *git init*.
